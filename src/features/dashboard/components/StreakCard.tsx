...
export default function StreakCard({
  ...
  const noData = current === 0 && longest === 0;

  if (noData) {
    return (
      <div className="bg-[#121212] p-6 rounded-xl border border-neutral-800 text-gray-500">
        No activity yet. Complete tasks to start building your streak.
      </div>
    );
  }
